...
function AvatarSection() {
  return (
    <>
      <div className="avat-and-bg w-90 md:w-80 lg:w-90 2xl:w-90 md:h-160 lg:h-170 xl:h-190 2xl:h-200 hidden lg:block fixed bottom-0 right-0 z-0 pointer-events-none">
