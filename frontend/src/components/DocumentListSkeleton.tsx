function DocumentListSkeleton() {
  return (
    <div className="document-section grid grid-cols-3 gap-5 w-[74%] pl-8 pr-10 py-5 z-1 relative border-t border-[#92613a] animate-pulse">
      <div className="doc-card flex flex-col gap-4 p-4 rounded-xl shadow-xl bg-[#d9c9bc64]">
        ...
        <div className="flex flex-col gap-2">
          <div className="content bg-[#c1b3a764] rounded w-55 h-3"></div>
          <div className="content bg-[#c1b3a764] rounded w-55 h-3"></div>
        </div>
      </div>
      <div className="doc-card flex flex-col gap-4 p-4 rounded-xl shadow-xl bg-[#d9c9bc64]">
